...
MooTools Accessible Button is a WAI-ARIA Enabled Button Plugin for Wordpress

== Description ==

MooTools Accessible Button is a button and uses the MooTools WAI-ARIA enabled button. Use it in a wide widget area, like the "First Footer Widget Area".
